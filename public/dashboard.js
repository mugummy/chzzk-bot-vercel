...
function renderMacroItem(m) {
    return `
        <div class="item-card" style="display:flex;justify-content:space-between;padding:10px;border-bottom:1px solid #333;">
            <div class="item-info">
                <span class="item-trigger" style="color:#7047eb;font-weight:bold;margin-right:10px;">${m.interval}분</span>
...
function renderCounterItem(c) {
    return `
        <div class="item-card" style="display:flex;justify-content:space-between;padding:15px;background:rgba(255,255,255,0.03);border-radius:10px;margin-bottom:10px;">
